...
namespace Turbo.Plugins.Default
{
    public class BloodShardPlugin : BasePlugin, IInGameTopPainter
    {
        ...
        public override void Load(IController hud)
        {
            ...
            string textFunc() => (ShowRemaining
                ? 500 + (Hud.Game.Me.HighestSoloRiftLevel * 10) - Hud.Game.Me.Materials.BloodShard
                : Hud.Game.Me.Materials.BloodShard).ToString("D", CultureInfo.InvariantCulture);

            string hintFunc() => ShowRemaining
                ? "amount of blood shards remaining"
                : "amount of blood shards";
