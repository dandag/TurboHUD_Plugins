namespace Turbo.Plugins.Default
{
    public class PlayerBottomBuffListPlugin : BasePlugin, IInGameTopPainter
    {
        ...
        public override void Load(IController hud)
        {
			...
			RuleCalculator.Rules.Add(new BuffRule(483552) { IconIndex = null, MinimumIconCount = 1, ShowStacks = true, ShowTimeLeft = false }); // Squirt's Necklace
			//RuleCalculator.Rules.Add(new BuffRule(430674) { IconIndex = 1, MinimumIconCount = 2, ShowStacks = true, ShowTimeLeft = false }); // 430674
			//RuleCalculator.Rules.Add(new BuffRule(484289) { IconIndex = null, MinimumIconCount = 1, ShowStacks = true, ShowTimeLeft = false }); // 2p new set dh
        }
